(function () {
    ...
    function ReverseZShapeComponent(x, y, width, height, basicLength) {
        this.width = width;
        this.height = height;
    ...
    ReverseZShapeComponent.prototype.update = function (bottomY, matrix) {
        let newSpeedY = 0;
    ...
    ReverseZShapeComponent.prototype.changeHorizontalSpeed = function (speedX, matrix, boundaryLeft, boundaryRight) {
        if (speedX > 0) {
    ...
    ReverseZShapeComponent.prototype.revertHorizontalSpeed = function () {
    ...
    window.ReverseZShapeComponent = ReverseZShapeComponent || {};
})();
